...
imwrite(uint8(HPnP_Re),strcat('./1_Result/',Final_Optsisng));

else
imwrite(uint8(im),strcat('./1_Result/',Final_Optsisng));
...
imwrite(uint8(HPnP_Re),strcat('./4_Result/',Final_Optsisng));

else
imwrite(uint8(im),strcat('./4_Result/',Final_Optsisng));
...
imwrite(uint8(HPnP_Re),strcat('./8_Result/',Final_Optsisng));

else
imwrite(uint8(im),strcat('./8_Result/',Final_Optsisng));
